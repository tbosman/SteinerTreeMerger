 ...
 * This version aborts calculation if upperbound exceeds maximum set value
 * 
 ...
 *
 */
public class MaxTwGreedyDegree< D extends InputData > implements Permutation<D>, UpperBound<D> {

	protected NVertexOrder<D> permutation;
	protected NGraph<GreedyData> graph;
	protected int upperBound;
	protected int maxTw = Integer.MAX_VALUE;
